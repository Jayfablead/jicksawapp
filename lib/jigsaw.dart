...
class JigsawWidgetState extends State<JigsawWidget> {
  ...
  images.add(tempImages);
      ...
      for (var x = 0; x <xSplitCount; x++) {
        print("hbnsj"+ math.Random().nextInt(2).isEven.toString());
        ...
        print("offsetcenter" + offsetCenter.toString());
        ...
        print("bottom"+jigsawPosSide.bottom.toString());
        print("left"+jigsawPosSide.left.toString());
        print("right"+jigsawPosSide.right.toString());
        print("top"+jigsawPosSide.top.toString());

        double xAxis = widthPerBlock * x;
        double yAxis = heightPerBlock * y;
        print("xaxis"+xAxis.toString());
...
print("offsetcenter"+offsetCenter.toString());
        ...
        final double heightPerBlockTemp = heightPerBlock +
          ...
          print("widthperblocktemp"+widthPerBlockTemp.toString());
          print("heightperblocktemp"+heightPerBlockTemp.toString());
