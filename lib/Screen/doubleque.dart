...
class doublech extends StatefulWidget {
  String? catId;
  String? ageId;

  doublech({Key? key, this.ageId, this.catId}) : super(key: key);

  @override
  State<doublech> createState() => _doublechState();
}
...
class _doublechState extends State<doublech> {
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    return commanScreen(
      ...
      scaffold: Scaffold(
        body: isloading
            ? Container()
            : questions?.getQuestionRandom?.quetionsOptions?.length == null ||
                    questions?.getQuestionRandom?.quetionsOptions?.length ==
                        0 ||
                    questions?.getQuestionRandom?.quetionsOptions?.length ==
                        null
                ? Container(
                    ...
                    child: Text(
                      'No Questions Available For You',
                      style: TextStyle(
                        color: Colors.black,
                        fontSize: 14.sp,
                        fontFamily: 'Poppins',
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          boxShadow: [
                            BoxShadow(
                                color: secondary, offset: Offset(0, 1.5.w))
                          ],
                      ...
                      ListView.builder(
                        ...
                        itemCount: questions
                            ?.getQuestionRandom?.quetionsOptions?.length,
                        itemBuilder: (context, index) {
                          return InkWell(
                            onTap: () {
                              setState(() {
                                ans = index;
                                op = questions?.getQuestionRandom
                            ...
                            child: Container(
                              ...
                              child: Text(
                                questions?.getQuestionRandom
                                        ?.quetionsOptions?[index].optionText ??
                                    '',
                                style: TextStyle(
                                  fontSize: 13.sp,
