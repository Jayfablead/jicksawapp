...
class JigsawClipper1 extends CustomPainter {
  void paint(Canvas canvas, Size size) {
    ...
    var endPoint2 = Offset(width*0.43, height);
    canvas.drawLine(startPoint2, endPoint2, linePaint);
    var startPoint3 = Offset(width*0.58, height);
...
class JigsawClipper8 extends CustomPainter {
  void paint(Canvas canvas, Size size) {
    ...
    paint.style = PaintingStyle.stroke;
    paint.strokeWidth = 1;
    var center = Offset(width*0.0,height*0.5);
    var center2 = Offset(width*0.0,height*0.5);
    var linePaint = Paint()
      ..color = Colors.black
      ..strokeWidth = 1;
    ...
    canvas.drawLine(startPoint1, endPoint1, linePaint);
    var startPoint2 = Offset(width*0.0, height*0.6);
...
class JigsawClipper11 extends CustomPainter {
  void paint(Canvas canvas, Size size) {
    ...
    paint.style = PaintingStyle.stroke;
    paint.strokeWidth = 1;
    var center = Offset(width*0.5,height*0.0);
    var center2 = Offset(width*0.0,height*0.5);
    var linePaint = Paint()
      ..color = Colors.black
      ..strokeWidth = 1;

    // var startPoint = Offset(width*0.0,height*0.2);
    ...
    var startPoint1 = Offset(width*0.0, height*0.0);
    var endPoint1 = Offset(width*0.43, height*0.0);
    canvas.drawLine(startPoint1, endPoint1, linePaint);
    var startPoint2 = Offset(width*0.58, height*0.0);
...
class JigsawClipper12 extends CustomPainter {
  void paint(Canvas canvas, Size size) {
    ...
    paint.style = PaintingStyle.stroke;
    paint.strokeWidth = 1;
    var center = Offset(width*0.5,height*0.2);
    var center2 = Offset(width*0.0,height*0.5);
    var linePaint = Paint()
      ..color = Colors.black
      ..strokeWidth = 1;
