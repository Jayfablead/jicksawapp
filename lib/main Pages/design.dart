                  ...
                  children: [
                    ...
                    Positioned(
                      ...
                      child: ClipPath(
                        ...
                        child: InkWell(onTap: () {
                          gamedata?.gameData?.steps == '11' ? showDialog(
                            context: context,
                            builder: (BuildContext context) {
                              return SizedBox(height: 20.h,
                                ...
                                child: AlertDialog(
                                  ...
                                  content: SizedBox(height: 19.5.h,
                                    child: Column(children: [
                                      Text('Choose any Task and do task to Get a piece'),     Padding(
                                        padding:  EdgeInsets.symmetric(horizontal: 15.w),
                                        child: Divider(color: Colors.black87,),
                                      ),
                                      TextButton(onPressed: gochoice, child: Text('Question',style: TextStyle(fontSize: 13.sp),)),
                                      Divider(color: Colors.black87,),
                                      TextButton(onPressed: gochoicech, child: Text('Challenge',style: TextStyle(fontSize: 13.sp),)),
                                    ],),
                                  ),
                                ),
                              );
