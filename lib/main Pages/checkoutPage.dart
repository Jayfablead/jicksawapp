                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            TextButton(onPressed: (){Get.off(AddCardPage( type: widget.type,
                              price: widget.price,
                              name: widget.name,
                              method: widget.method,
                              imgs: widget.imgs,
                              sub: widget.sub,));}, child: Text(
                              'Edit',
                              style: TextStyle(
                                  color: primary,
                                  fontSize: 14.sp),
                        ...
                        Row(
                          ...
                          children: [
                            Text(
                              '* * * * ' + (viewcard?.cardDetails?.showCardNumber).toString(),
                              style:
                                  TextStyle(color: Colors.black, fontSize: 15.sp),
                            ),
                            Text(
...
print(subs?.status);
          if (response.statusCode == 200 && subs?.status == "success") {
            Get.to(PurchaseTYPage(price: widget.price,name: widget.name,method: widget.method,type: widget.type,),);
